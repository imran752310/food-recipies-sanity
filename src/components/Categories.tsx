  ...
  return (
    <>
      <div className="w-[90%] m-auto my-16">
        <div>
          <h1 className=" font-bold text-[30px] mb-10 border-b-2 py-4">
          ...
          <div>
            <div className="relative ">
              ...
              <div className="absolute top-8  left-4">
                ...
                <button className="bg-green-500 hover:bg-green-600 text-white border-none p-2">
                  Read More
                </button>
              </div>
            </div>
          ...
          <div>
            <div className="relative  ">
              ...
              <div className="absolute top-8  left-4">
                ...
                <p className="text-white text-sm pb-5">Simple & Delicious</p>
                <button className="bg-green-500 text-white hover:bg-green-600 border-none p-2">
                  Read More
                </button>
              </div>
            </div>
