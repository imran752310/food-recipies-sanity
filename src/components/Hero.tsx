...
const Hero = () => {
  return (
    <section className="relative w-full h-[90vh]">
      ...
      {/* Content */}
      <div className="absolute left-10 top-1/2 -translate-y-1/2 bg-black/40 border-l-4 border-green-500 p-10 max-w-xl text-white">
        <h1 className="text-3xl font-bold mb-4">Delicios Homemade Burger</h1>
        <p className="mb-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras tristique nisi vitae luctus
          sollicitudin. Fusce consectetur sem eget dui tristique, ac posuere arcu varius.
        </p>
